...
mkdir vm
cd vm
set cc=D:\PRGRMMNG\SoF2SDK\bin\sof2lcc -A -DQ3_VM -DMISSIONPACK -S -Wf-target=bytecode -Wf-g -I..\..\..\gametype -I..\..\gt_cctf -I..\..\..\game %1
...
D:\PRGRMMNG\SoF2SDK\bin\sof2asm -f ../gt_cctf
@if errorlevel 1 goto quit
